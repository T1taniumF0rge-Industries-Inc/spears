package net.mcreator.spears.entity;
...
public class InvisibleProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.AIR);
	private int knockback = 0;

	public InvisibleProjectileEntity(EntityType<? extends InvisibleProjectileEntity> type, Level world) {
		super(type, world);
	}

	public InvisibleProjectileEntity(EntityType<? extends InvisibleProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public InvisibleProjectileEntity(EntityType<? extends InvisibleProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static InvisibleProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 5, 2);
	}

	public static InvisibleProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 5, 2);
	}

	public static InvisibleProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		InvisibleProjectileEntity entityarrow = new InvisibleProjectileEntity(SpearsModEntities.INVISIBLE_PROJECTILE.get(), entity, world, null);
	...
	public static InvisibleProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		InvisibleProjectileEntity entityarrow = new InvisibleProjectileEntity(SpearsModEntities.INVISIBLE_PROJECTILE.get(), entity, entity.level(), null);
