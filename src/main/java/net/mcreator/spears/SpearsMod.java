...
import net.mcreator.spears.init.SpearsModTabs;
...
public class SpearsMod {
	public static final Logger LOGGER = LogManager.getLogger(SpearsMod.class);
	public static final String MODID = "spears";

	public SpearsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		SpearsModItems.REGISTRY.register(modEventBus);
		SpearsModEntities.REGISTRY.register(modEventBus);
		SpearsModTabs.REGISTRY.register(modEventBus);
		SpearsModVariables.ATTACHMENT_TYPES.register(modEventBus);
